...
export const CanvasRevealEffect = ({
  animationSpeed = 0.8,
  opacities = [0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1, 1, 1, 1],
  colors = [
    [255, 20, 147], 
    [220, 20, 60],
    [255, 105, 180] 
      ...
      <div className="h-full w-full">
        <DotMatrix
          ...
          shader={`
            ...
            opacity *= clamp((1.0 - step(intro_offset + 0.15, u_time * animation_speed_factor)) * 1.5, 1.0, 1.5);
            opacity *= 1.5; // Increase overall opacity
          `}
          center={["x", "y"]} 
        />
      </div>
      {showGradient && (
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-[84%]" />
      )}
    </div>
  );
};
