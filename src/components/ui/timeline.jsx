  ...
  return (
    (<div
      ...
      <div className="max-w-7xl mx-auto pt-10 pb-[-5] px-4 md:px-8 lg:px-0">
        <h2 className="text-4xl md:text-6xl mb-4 font-bold text-[#9b1b21] dark:text-[#9b1b21] max-w-4xl">
          Heist Timeline
        </h2>
        {/* <p
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-10 md:gap-0">
            <div
              ...
              <h3
                className="hidden md:block text-xl md:pl-20 md:text-3xl font-bold text-[#9b1b21] dark:text-[#9b1b21] ">
                {item.title}
              </h3>
            </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3
                className="md:hidden block text-2xl mb-4 text-left font-bold text-[#9b1b21] dark:text-[#9b1b21]">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
